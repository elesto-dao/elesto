...
var (
	ErrCredentialIssuerNotFound   = sdkerrors.Register(ModuleName, 1100, "did document not found")
	ErrCredentialIssuerFound      = sdkerrors.Register(ModuleName, 1101, "did document found")
