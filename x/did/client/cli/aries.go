...
func NewLinkAriesAgentCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "link-aries-agent [didID] [serviceID] [aries-agent-api-url] [service-endpoint]",
		Short:   "create a service and add a keyExchange method and relationship from an aries agent",
		Example: `elestod tx link-aries-agent 7ad6f387-e083-4575-a767-469046db4225 agent1 http://localhost:7090 http://localhost:7091`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			didID := did.NewChainDID(clientCtx.ChainID, _didID)
			// add a new verification method based on the key generated by aries
			vmID := didID.NewVerificationMethodID(keyID)
			...
			msgAV := did.NewMsgAddVerification(
				didID.String(),
				verification,
				signer.String(),
			)
