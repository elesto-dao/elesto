...
This article describes the legal requirements to create a Cosmos-SDK powered regulatory compliant e-money token. This token would have the same guarantees as to the traditional banking sector, thus bringing true liquidity to the crypto world. 

In this paper, the regulatory environment within Europe will be laid out. It will outline how the regulations have been drawn up and define DLT based assets and the requirements based on these classifications. It will also briefly review the roles and permits required to perform activities relating to crypto-assets.
...
- - With respect to AML, some attention should be paid to the FATF "travel rule," which is not contained in the current EU directive but is part of FATF recommendations;
...
- The EU regulatory requirements relating to the implementation of Central Bank Digital Coins (CBDC) are likely to lead to delays, but a regulated protocol with a consortium of issuers could be a way forward.

# Acknowledgements

The authors of this article would like to thank
...
This paper represents the opinions and views of the authors. It should not be in any way construed as legal advice.
...
Readers of this document will doubtless believe that DLT is indeed a tool of public good that can change finance for the better for millions of people. However, appropriate regulation is necessary to transition, especially as the technology matures. 
...
- **Neutral approach**, seeking to promote case-by-case assessments on the relevant circumstances and eventually attempting to reconduct such assets and activities to existing legislation and regulations (mainly within the payment and investment services spheres);
...
In terms of economy and demographics, the EU is globally extremely important. However, concerning DLT-based assets, as of September 2020, the EU has also taken the lead in creating the first harmonised and cross-border framework applicable to crypto-assets and related activities.
...
Financial legislation is guided and implemented through a network of international and national bodies. The scope of each body is defined  as per the table below [@Judge:CryptoLandscape]:

![Authorities involved in the legal and regulatory framework](../imgs/CosmosCashRegs/RegulatorTable.png)

A number of supranational and intergovernmental bodies such as the Bank of International Settlements (BIS), and the Financial Action Task Force (FATF), with respect to their role and responsibilities, advise on best practice, policy, and standards. For BIS this is the central bank and monetary policy; for FATF this is money laundering and terrorism financing.

Within the European Union (EU), the commission turns policy and guidelines - like FATF recommendations - into draft legislation approved by the European Parliament and the Council of Ministers.
...
The background above outlined the EU package to support DLT technologies. This package includes a proposal for a pilot regime on DLT market infrastructures, a proposal for digital operational resilience, and clarifying or amending certain related EU financial services rules. This proposal for a "Regulation of The European Parliament And of The Council on Markets in Crypto-assets, and amending Directive (EU) 2019/1937" is also known as “MiCA” [@EU:MiCA].

MiCA follows several supervisory opinions, guidance, industry-wide consultations, and international reports. It is drafted with several core goals in mind:
...
In addition to these articles, other directives apply cross-asset/service. The most important for crypto-assets is the 5th Anti-Money Laundering Directive (Directive 2018/843), known as AMLD5 [@EU:AMLD5]

Given that MiCA has been drafted on the basis of leveraging existing legislation, by design, it favours those entities already licensed under existing financial services regulation. By way of an example, if a firm is already licensed to issue an asset (under MiFiD or e-money), then the barriers to a DLT token can be issued very easily through the completion of steps defined under MiCA.
...
All the definitions of MiCA (as per next section) come under this remit, excluding security tokens where they are digital representations of the existing securities/assets. FATF also refers to a range of underlying technologies, not just DLT.
...
**Utility Tokens** is a type of crypto-asset that is intended to provide digital access to a DLT-based good or service. The important features of this class of token is that:

- The issuer only accepts it;
- In general, it has non-financial purposes.

**Methods of payment**

- **CBDC**: these may be defined digital assets issued by a public authority (i.e., central banks, in the form of central bank liability), often referred to as sovereign tokens (namely a central bank) to ensure smooth and frictionless payment and settlement solutions, in either retail or wholesale transactions.
- **Payment tokens / Cryptocurrencies**: these instruments are those crypto-assets that are designed as an alternative to government issued fiat money, i.e., they are intended to perform the roles of a medium of exchange, store of value, and unit of account. These are often referred to as virtual currencies or coins. Classic examples are Bitcoin and Litecoin,
...
E-money tokens (EMT) are a sub-category of stablecoins, but the key characteristic is that value stability is achieved by referencing *only one fiat currency* rather than a basket of assets. Effectively, they are a proxy for a fiat currency that is legal tender. They are not a CBDC because a public body does not issue them.
...
- The degree of interconnectivity of the EMT with the financial system - the measure of this is unclear.
...
- **Oversight** - Set-up of an EBA chaired and managed supervisory college, which issuers pay based on the size of issuance.
...
- The offering of crypto-assets is addressed to fewer than 150 natural or legal persons per member state acting on their account;
- The total consideration of such an offering in the Union does not exceed €1,000,000, or the corresponding equivalent in another currency or crypto-assets, over a period of 12 months;
...
**Case 2: The knowledge and experience of audience**, i.e., the offering of crypto-assets (e.g., asset-referenced tokens/e-money tokens), is solely addressed to qualified investors, and such qualified investors can only hold the crypto-assets.
...
Entities licensed to offer these services are called CASP's **(Crypto-Asset Service Providers).** An entity that offers multiple services must apply for each license as needed. Note that these licenses can expire if not used.
...
However, this paper's view is that this relation is not reciprocal, i.e., entities licensed under MiCA are not licensed under MiFID. Thus, a firm licensed to advise on crypto-assets can not offer advisory on other securities.

For MiFID licensed firms, the only additional requirements under MiCA to issue an asset referenced token is the need to fulfill white paper requirements as outlined in Appendix \ref{sec:whitepaper}

### Issuers

In addition to the roles outlined above, MiCA draws a tripartite distinction among categories of issuers based on the type of crypto-asset issued:
...
- **Issuers of stablecoins (asset-referenced tokens):**  Issuers of stablecoins are required to be authorised by their home state regulator, which shall assess their compliance with a list of prudential, the conduct of business (including requirements on custody of reserve assets), and governance requirements. Issuers shall be required to draft a white paper, having the minimum content set out under MiCA relating to the offer of stablecoins that the issuer’s home state regulator must approve prior to the offer.
...
The EU comprises 27 member states. The regulatory burden of registering in each member state would be too onerous, despite purporting to be a single market. Therefore the concept of passporting was introduced. Passporting allows entities authorised to conduct certain business in one jurisdiction to only satisfy registration requirements in another EU jurisdiction to conduct cross-border business.

MiCA introduces the same EU-wide passport concept available to market participants who become licensed under the MiCA regime in their home member state, again replicating the existing features of traditional investment services legislation. 

Passporting represents a breakthrough in the industry as it effectively ensures the cross-border provision of crypto-related services across the EU, creating a level playing field among EU member states.
...
The combination of lack of regulation, anonymity, and global reach has made DLT based tokens useful tools in money laundering. Over time FATF has defined and subsequently clarified the definitions of virtual assets, their providers, and the application of guidelines to these assets.

AMLD5 is a significant issue for DLT based technologies to address to get regulatory approval.

## EU AML implementation

Within the EU, FATF guidelines are implemented through the 5th Anti-Money Laundering Directive (Directive 2018/843) [@EU:AMLD5]. Broadly this is a multi-level risk based approach. Each country may assess its vulnerability to money laundering and take appropriate steps. Each organisation will decide on the risk they are prepared to accept and identify the risk they are subject to, including product range, customer types, etc.

AML processes in financial service providers follow a model of "Know Your Client/Business" (KYC/KYB) and then, based on the results of this, an ongoing process of either:

- Client Due Diligence (CDD); or
- Enhanced Due Diligence (EDD)

Which may be fine-grained as needed.
...
There may be additional checks resulting checks, particularly if the client is a "politically exposed person," then these persons - and family - would also qualify for a higher risk rating.

### CDD / EDD

Once these checks are done and risk rating established, ongoing checks last for the entire business relationship. It includes:

- Regular KYC reviews and re-rating of risk.
- Ongoing transactions checks. 

In cases where the transaction is unusual, large, complex, or of unclear purpose in relation to the client business and against similar classes of business, or the transaction involves high-risk third countries, it should be flagged and investigated. Unexplained transactions are identified and raised as a "Suspicious Activity Report" with the relevant authority within the jurisdiction.

The checks and controls themselves are based on a risk model, and risks change with time - for example, new guidance, products, threats, etc. The models themselves need to be reassessed at regular intervals.

The AMLD5 requires member states to create central databases comprised of crypto users’ identities and wallet addresses and authorise national FIUs to access the information stored in them. This means that AML subject firms are legally required to register their businesses with local authorities in the EU and retain the documents regarding the conducted CDD and recorded transactions to hand over identifiable user information to FIUs if requested, such as real names and addresses.

## The Penalties

By way of illustrating the seriousness of AMLD5, severe sanctions and penalties may be applied to obliged entities that do not apply appropriate measures in line with the requirements. The maximum financial penalty for a breach equals at least twice the amount of the benefit derived from the breach where that benefit can be determined, or at least EUR 1,000,000.
...
From the above, it is clear that where there is a "gateway" into the network, there is an AML/CFT responsibility, which implies
...
FATF then suggests that developers and governance bodies are subject to AML/CFT because
...
Under the AML/CFT perspective, the regulatory requirements of validators are somewhat different. FATF, in their guidance, state the following: 
...
Further to the off-chain considerations, additional control and procedures include the internal risk model, ongoing transaction monitoring plan, reporting, record-keeping, and internal control.
...
It is worth highlighting the types of institutions that can issue e-money tokens. 

As noted, two types of institutions can issue such tokens: Credit Institutions and E-Money Institutions.

Credit institutions are, in fact, banks and therefore hold a banking license. In a more generic sense, these can also be considered "fractional" banks, the predominant banking model in the EU (and much of the developed world). These institutions can do the following:

- Take deposits AND lend to clients;
- Pay/receive interest on deposits/loans;
- Make deposits and borrow from the central bank;
- Are backed by a deposit insurance scheme.

Because credit institutions benefit from the central bank and deposit insurance, they are subject to greater capital requirements, enhanced regulation and greater scrutiny, and enhanced risk management.

In contrast, E-Money Institutions have a much more limited scope. An equivalent regulatory regime matches this. These institutions can do the following:
...
In contrast to Credit Institutions, EMI's can be considered a "narrow" bank type.

# Application of regulations to CBDC

At this point is worth reviewing the situation regarding the regulation of CBDC. According to MiCA, CBDCs are exempted from the regulation if crypto-assets are issued by central banks acting in their monetary authority capacity or by other public authorities. However, as pointed out in the literature[@EBI:CryptoMarkets]
...
To summarise, CBDC is exempt from regulation if the token is issued by a central bank directly to retail customers. However, this is contrary to the current operating model of the interbank market and presents significant risk as it represents a fundamental change in the operating model. 

Conversely, third parties acting on behalf of a central bank in implementing a CBDC would be subject to regulatory oversight under the significant token requirements, which seems punitive.

As [@EBI:CryptoMarkets] and [@IMF:RiseDigitalMoney] both note, the two-tier CBDC/e-money model is likely to be the best operating model generally (consider the Digital Yuan project). Based on the impasse outlined above, within the EU, presently, this does not look likely.

# Cosmos Cash

## Definition

Cosmos Cash is intended to offer features typical of electronic money, adopting the blockchain technology as underlying infrastructure, thus leading to a digital asset to be applied within the payment industry. Using the conceptual framework outlined by Adrian & Griffoli [@IMF:RiseDigitalMoney], Cosmos Cash would be acting as a claim based asset with a fixed value redemption, using a private backstop and ultimately built on Blockchain technology.

More specifically, Cosmos Cash would be built as a digital token that references a fiat currency (or a digital representation of a fiat currency) based on assets held by the issuer using a Tendermint-based network.
...
- **Issuers** - one or more approved parties with the authority to mint, burn and hold reserves of tokens. They use fiat reserves (and digital representations) to issue and redeem tokens presented by customers. They would also offer functionality and services through customer wallets;
- **Validators** are entities that validate and settle transactions on the Tendermint network;
- **Holders/customers** who can send, receive and redeem tokens from the network. These can be legal entities and private individuals. They would need to complete a KYC process before joining the network successfully.
...
7. Any redemption conditions are clearly stated, including any fees and processing times.
...
- The marketing communications shall be identified as such;
- The information shall be fair, transparent, and not misleading. It should be clear that holders have the right of redemption at par value at any time;
...
- Communications shall indicate the address of the issuer's website of the e-money tokens.
...
- Financial services licensed under existing EU regulation have advantages under new crypto-asset legislation.
...
- The EU regulatory requirements relating to the implementation of Central Bank Digital Coins are likely to lead to delays, but a regulated protocol with a consortium of issuers could be a way forward.

From this, it is clear that AML is a prime area of concern and who would use such a protocol, given the hurdles to entry.

## AML/CFT

AML/CFT is an area of significant risk and opportunity for Cosmos Cash. The anonymity of existing payments coins needs to be eliminated with features such as:

- Reduce and eliminate off-chain transactions;
- Establish a link between identity between wallet holders;
- Eliminate mechanisms for hiding identity;
- Maintain privacy for clients in-line with GDPR requirements;
- Freeze tokens and accounts in the event of suspicious events.

There is a point of regulatory risk for validators on the chain underlying a Cosmos cash protocol, such that they are classed as a Financial Institution/VASP. This would need to be mitigated/eliminated as the costs of setting up legal mechanisms, and AML compliance may be punitive.

There is not only a risk but an opportunity. According to the latest reports [@LexisNexis:2019Costs], Financial Crime Compliance costs (including but not limited to AML) in EMEA were USD 137 Bn in 2019. On average, 74% of that cost is staffing [@LexisNexis:2017Costs]. An on-chain protocol with AML/CFT shared between issuers and CASPs could offer significant benefits to financial regulators and law enforcement in identifying and researching payment patterns.

This presents opportunities to leverage Cosmos based technologies in decentralised identity and zero knowledge proofs. It also offers opportunities to bring in parties with expertise in transaction analysis and data mining capabilities.

## Secondary Market

As liquidity and transferability are the indisputable advantages of the DLT: this would require Cosmos Cash to cater for transferability features that would not affect the frictionless and seamless nature of DLT-based transfers. However, it would need to cater for safeguards ensuring that transactions among customers take place in a safe, transparent, and compliant framework. 

From the analysis above, it is clear that there will be a license-based approach for each financial service, whether wallets, exchanges, advisory, etc. Ideally, such services should be governed without a centralised authority.
...
- Already licensed and established players seeking access to the crypto market through a fully regulated and disruptive solution such as Cosmos Cash; and
- Incumbent firms that may be willing to get licensed to support Cosmos Cash issuances.
...
The second scenario of incumbent firms looking for a license, as Amagis suggests, would be that Cosmos Cash could build an open-source tool kit that supports such users in becoming eligible issuers. It should be noted that these firms should rely on third parties such as Amagis Capital for non-chain activities such as structuring licensing.

## Ecosystem Integration

Although the protocol is important, as Amagis points out, coordination with other stakeholders will be equally important. Stakeholders can include
...
- The **Identity** module is the core module and allows tracking of **AML** and **KYC** data in a trustless and secure way that also allows privacy
- The **Issuer** module handles creating and tracking issuers, this allows the issuer to revoke tokens and freeze tokens if necessary
...
Decentralised identifiers[@Sporny:20:DI] and verifiable credentials[@Sporny:19:VCD] can be combined to construct self-sovereign identities on a sovereign blockchain, but how can privacy be maintained and comply with AML regulations? This can be done through leveraging up and coming advancements in the Cosmos eco-system such as Coconut [@ICF:coconut][@Nym:Coconut][@1802.07344] for selective disclosure of personally identifiable information. This could facilitate regulatory oversight and privacy in a decentralised public application.
...
This leads to the second point, which is the proposal to remove send transactions. This is handled by an AML function that reviews the transaction against the users' AML profiles. Non-acknowledgments are referred to the regulator (or other actors) for intervention.
...
10. Except for e-money issuers who are exempted from authorisation in accordance with Article 43(2), details about the authorisation as an issuer of e-money tokens and the name of the competent authority which granted authorisation.

**Information about the project**

1. Details of all natural or legal persons (including addresses and/or domicile of the company) involved in design and development, such as advisors, the development team and crypto-asset service providers.
