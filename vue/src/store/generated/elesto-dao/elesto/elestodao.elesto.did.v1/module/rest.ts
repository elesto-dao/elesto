...
export type V1MsgAddControllerResponse = object;

export type V1MsgAddServiceResponse = object;

export type V1MsgAddVerificationResponse = object;

export type V1MsgCreateDidDocumentResponse = object;

export type V1MsgDeleteControllerResponse = object;

export type V1MsgDeleteServiceResponse = object;

export type V1MsgRevokeVerificationResponse = object;

export type V1MsgSetVerificationRelationshipsResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryDidDocument = (id: string, params: RequestParams = {}) =>
    this.request<V1QueryDidDocumentResponse, RpcStatus>({
