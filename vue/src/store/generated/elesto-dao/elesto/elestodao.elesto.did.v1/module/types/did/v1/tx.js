...
export class MsgClientImpl {
    ...
    CreateDidDocument(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "CreateDidDocument", data);
    ...
    AddVerification(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "AddVerification", data);
    ...
    RevokeVerification(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "RevokeVerification", data);
    ...
    SetVerificationRelationships(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "SetVerificationRelationships", data);
    ...
    AddService(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "AddService", data);
    ...
    DeleteService(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "DeleteService", data);
    ...
    AddController(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "AddController", data);
    ...
    DeleteController(request) {
        ...
        const promise = this.rpc.request("elestodao.elesto.did.v1.Msg", "DeleteController", data);
