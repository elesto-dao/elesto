...
import ElestoDaoElestoElestodaoElestoDidV1 from './elesto-dao/elesto/elestodao.elesto.did.v1'
...
export default { 
  ...
  ElestoDaoElestoElestodaoElestoDidV1: load(ElestoDaoElestoElestodaoElestoDidV1, 'elestodao.elesto.did.v1'),
